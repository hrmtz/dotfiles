...
install_tool "lsd" "modern ls (LSDeluxe)" "lsd"
install_tool "bat" "enhanced cat" "bat"
install_tool "rg" "fast grep (ripgrep)" "ripgrep"
install_tool "fd" "modern find" "fd-find"
install_tool "jq" "JSON processor" "jq"
install_tool "delta" "git diff enhancement" "delta"
