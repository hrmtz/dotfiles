# p10k configuration for Ubuntu on WSL.
# Based on the default p10k-rainbow config with Ubuntu brand colors
# (Orange #E95420 + Aubergine #77216F).
#
